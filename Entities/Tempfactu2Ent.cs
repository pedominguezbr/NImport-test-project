...
{
	[DataContract()]
	public partial class Tempfactu2Ent
	{
		...
		public Tempfactu2Ent() { }

		public Tempfactu2Ent(string enc_id, DateTime? fecha, string producto, int? cantidad, string cliente, DateTime? fech1, DateTime? fech2, string trial716)
		{
			this.Enc_Id = enc_id;
			this.Fecha = fecha;
