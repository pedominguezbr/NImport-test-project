...
{
	[DataContract()]
	public partial class DeRemisiónEnt
	{
		#region Private Properties
		private TIENDAEnt art_id;
		private RemisiónEnt enc_id;
		...
		public DeRemisiónEnt() { }

		public DeRemisiónEnt(TIENDAEnt art_id, RemisiónEnt enc_id, string tem_nomb, double? cantidad, double? precio, double? predescto, double? descuento, double? tem_subt, string trial605)
		{
			this.ART_ID = art_id;
			this.ENC_ID = enc_id;
