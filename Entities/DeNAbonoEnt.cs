...
{
	[DataContract()]
	public partial class DeNAbonoEnt
	{
		#region Private Properties
		private TIENDAEnt art_id;
		private NAbonoEnt enc_id;
		...
		public DeNAbonoEnt(TIENDAEnt art_id, NAbonoEnt enc_id, string tem_nomb, double? cantidad, double? precio, double? predescto, double? descuento, double? tem_subt, string trial560)
		{
			this.ART_ID = art_id;
			this.ENC_ID = enc_id;
