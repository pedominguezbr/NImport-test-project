...
{
	[DataContract()]
	public partial class Tabla1Ent
	{
		...
		public Tabla1Ent(int? art_id, string enc_id, string tem_nomb, double? cantidad, double? precio, double? predescto, double? descuento, double? tem_subt, string trial713)
		{
			this.ART_ID = art_id;
			this.ENC_ID = enc_id;
