...
{
	[DataContract()]
	public partial class TempGuiaEnt
	{
		...
		public TempGuiaEnt(string enc_id, DateTime? fecha, string producto, double? cantidad, string cliente, DateTime? fech1, DateTime? fech2, string trial716)
		{
			this.Enc_Id = enc_id;
			this.Fecha = fecha;
