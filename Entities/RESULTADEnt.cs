...
{
	[DataContract()]
	public partial class RESULTADEnt
	{
		...
		private string trial667 = string.Empty;
		#endregion
		...
		[DataMember()]
		public string TRIAL667
		{
			get { return this.trial667; }
			set { this.trial667 = value; }
		}
		#endregion

		public RESULTADEnt() { }

		public RESULTADEnt(TIENDAEnt art_id, FacturasEnt enc_id, string tem_nomb, double? cantidad, double? precio, double? predescto, double? descuento, double? tem_subt, string trial667)
		{
			this.ART_ID = art_id;
			this.ENC_ID = enc_id;
