...
{
	[DataContract()]
	public partial class TEMPORALEnt
	{
		...
		public TEMPORALEnt(string enc_id, int? art_id, string tem_nomb, int? cantidad, double? precio, double? precio2, double? descuento, double? predescto, double? igv, double? tem_subt, DateTime? fecha, int? cli_id, string cod_ven, string trial716)
		{
			this.ENC_ID = enc_id;
			this.ART_ID = art_id;
